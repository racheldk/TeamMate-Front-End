...
export default function PendingGameDetail({ token, currentGame, setCurrentGame }) {
    ...
    return (
        <Box>
            <Heading>PendingGameDetail Component</Heading>
            ...
            <Box className="game-card" key={currentGame.id}>
                ...
                {currentGame.host_info.length>0 && (
                    <>
                        ...
                        />
                        <Text>
                            NTRP: {currentGame.host_info.profile.ntrp_rating}{" "}
                        </Text>
                    </>
                )}
                ...
                {/* {currentGame.buttonLabels.map((label)=>{
                    (<Button>test</Button>)
                })} */}
            </Box>
        </Box>
